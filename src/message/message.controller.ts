...
export class MessageController {
    ...
    public static async resolve() {
        if (!MessageController.instance) {
            const messageService = await MessageService.resolve();
    ...
    public async getGroupMessages(request: Request) {
        ...
        return new Response().json(HttpStatus.OK, messages);
    }
    ...
    public async findOne(request: Request) {
        ...
        return new Response().json(HttpStatus.OK, { message: messsageDto });
    }

    public async create(request: Request) {
        const createMessageDto = plainToInstance(
            CreateMessageDto,
            request.body
        );
