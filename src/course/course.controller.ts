...
export class CourseController {
    ...
    public async getCourseStudents(request: Request) {
        const paginationDto = plainToInstance(PaginationDto, request.query);
        const courseId = parseInt(request.params.courseId);
        const students = await this.courseService.getCourseStudents(
            courseId,
            paginationDto
        );

        return new Response().json(HttpStatus.OK, students);
    }
    ...
    public async getCourses(request: Request) {
        ...
        return new Response().json(HttpStatus.OK, courses);
    }
    ...
    public async subscribe(request: Request) {
        ...
        return new Response().text(
            HttpStatus.OK,
            "You've successfully subscribed to the course..."
        );
    }
    ...
    public async unsubscribe(request: Request) {
        ...
        return new Response().text(
            HttpStatus.OK,
            "You've successfully unsubscribed to the course..."
        );
    }
    ...
    public async create(request: Request) {
        ...
        return new Response().json(HttpStatus.OK, { course: courseDto });
    }
